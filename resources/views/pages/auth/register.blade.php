    ...
    <main class="form-signin">
        <form method="POST" action="{{route('register')}}">
            ...
            <div class="form-floating">
                <input required type="text" name="first_name" class="form-control" value="{{old('firstname')}}" autocomplete="given-name" id="floatingInput" placeholder="John Doe">
            ...
            <a href="{{route('login')}}" class="mt-3 d-block small">Already have an account? Please, log in.</a>
